...
check_status <- function(res){
  ...
  if(length(jsonlite::fromJSON(rawToChar(res$content))$value) == 0){ warning(paste0("The API returned an empty dataset (without error). Are you sure you specified the request correctly?")) }

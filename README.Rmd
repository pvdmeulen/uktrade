...
Similarly, specifying `commodity = 0` or `commodity = NULL` will load all commodities (this may take considerable time):

```{r load_ots example with join and commodity0}
library(uktrade)
data <- load_ots(month = 201901, commodity = 0, join_lookup = TRUE)

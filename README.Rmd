...
Note that the month argument specifies a range in the form of `c(min, max)`, not two months.
...
Loading all UK regional trade of 2-digit SITC Divisions '00 - Live animals other than animals of division 03' to '11 - Beverages' for 2019 is done by specifying `sitc = c(00, 11)` (leading zeros are removed). This again specifies a range (like with months) to avoid URLs being too long.
